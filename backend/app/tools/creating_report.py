...
def create_compact_prompt_for_recommendations(monitoring_data: Union[list[dict], None], forecast_data: list[dict],
                                              object_name: str,
...
def create_report(id: int, type: str, year_from: int, year_to: int) -> str:
    ...
    if year_to > year_monitoring_to:
        ...
        prompt = create_compact_prompt_for_recommendations(monitoring_data, forecast_data, object_name, year_from,
                                                           year_to)
